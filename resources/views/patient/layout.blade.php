    ...
    <aside class="w-64 bg-white shadow-lg p-6 flex flex-col">
        ...
        <nav class="flex flex-col space-y-2">
            <a href="{{ route('patient.dashboard') }}" class="px-3 py-2 rounded hover:bg-gray-200">Tableau de bord</a>
              <a href="{{ route('patient.reserve') }}" class="block px-4 py-2 hover:bg-gray-200 rounded">
            Réserver un ticket
        </a>
          <a href="{{ route('patient.tickets') }}" class="block px-4 py-2 hover:bg-gray-200 rounded">
            Mes tickets
        </a>
            <a href="#" class="px-3 py-2 rounded hover:bg-gray-200">Notifications</a>
        </nav>
        <div class="mt-auto">
